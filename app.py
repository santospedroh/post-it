...
def consult():
    ...
    sql = "SELECT nome, mensagem, datetime(criado_em,'localtime') as criado_em FROM post ORDER BY criado_em DESC"
...
# def save(nome, mensagem):
    ...
    #curr = conn.cursor()
    # salva
    # curr.execute("INSERT into post (nome, mensagem) values (?,?)",
    #             (nome, mensagem))
    # conn.commit()
